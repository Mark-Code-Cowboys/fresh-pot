...
class _PaywallSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PaywallSheetScaffold(
      ...
      body: 'Your first $kFreeBeanLimit bags and every note you\'ve '
          'written stay yours forever — nothing is ever locked away. '
          'Pro keeps the journal growing. No account, and your notes '
          'never leave this phone.',
      benefits: const [
        PaywallBenefit(
          icon: Icons.all_inclusive,
          title: 'Unlimited bags',
          detail: 'Every roaster, every experiment, on the shelf.',
        ),
        PaywallBenefit(
          icon: Icons.insights_outlined,
          title: 'Brew trends',
          detail: 'Ratings by roaster and origin, your brewing year.',
        ),
        PaywallBenefit(
          icon: Icons.ios_share_outlined,
          title: 'Export and backup',
          detail: 'Your notes back out — CSV and full backup.',
        ),
      ],
